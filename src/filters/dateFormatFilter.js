...
Vue.filter("dateFormatTimeStamp", dateFormatTimeStamp);
function dateFormatTimeStamp(i) {
...
Vue.filter("dateFormatMassage", dateFormatMassage);
function dateFormatMassage(i) {
  let value = parseInt(i.toString());
  var data = new Date(value);
  if (isThisYear(value)) {
...
Vue.filter("dateFormatTree", dateFormatTree);
function dateFormatTree(i) {
  let value = parseInt(i.toString());
  var data = new Date(value);
  if (isThisYear(value)) {
    if (isJustRecently(value)) return "刚刚";
