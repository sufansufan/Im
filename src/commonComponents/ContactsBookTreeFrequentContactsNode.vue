<template>
  <div
    id="ContactsBookTreeFrequentContactsNode"
    :style="'padding:calc(('+ height +' - '+ headPortraitWidth +') / 2) 0;width:'+ width +';height:calc('+ height +' - ('+ height +' - '+ headPortraitWidth +'))'"
  >
    <!-- 头像 -->
    <ImHeadPortrait
      :url-list="['/static/icon/02应用图标—icon/my_icon.png']"
      defaultUrl="/static/icon/02应用图标—icon/my_icon.png"
      errorUrl="/static/icon/02应用图标—icon/my_icon.png"
